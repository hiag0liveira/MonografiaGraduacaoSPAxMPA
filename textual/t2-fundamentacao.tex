...
No contexto deste trabalho, o \textbf{GitHub Projects} foi utilizado para planejar e acompanhar o desenvolvimento das plataformas \textit{WallTech-CSR} e \textit{WallTech-SSR}. A organização das tarefas em sprints e o uso de um fluxo Kanban contribuíram para a gestão ágil do projeto, promovendo maior visibilidade sobre o andamento das atividades e colaboração entre os membros da equipe.
