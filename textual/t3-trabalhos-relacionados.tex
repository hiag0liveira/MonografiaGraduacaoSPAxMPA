...
\label{cap:trabalhos}
Este capítulo apresenta os trabalhos relacionados ao objeto de pesquisa, obtidos por meio de um mapeamento sistemático da literatura, realizado com base em um protocolo descrito a seguir, utilizado para atingir os objetivos da pesquisa.
